            ...
            <div class="container my-5">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox runat="server" ID="txtUserPassword" class="form-control" placeholder="Password Trainer" />
                ...
                <!-- Botón -->
                <div class="text-end">
                    <asp:Button Text="Dar de alta" ID="btnCreateTrainer" onClick="btnCreateTrainer_Click" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalGuardarCambios" runat="server" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
