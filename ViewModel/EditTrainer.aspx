<%@ Page Title="" Language="C#" MasterPageFile="~/AllMaster.Master" AutoEventWireup="true" CodeBehind="EditTrainer.aspx.cs" Inherits="ViewModel.EditTrainer" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="container my-2">
                <h2 class="mb-4">Editar Trainer</h2>
                <%--id Trainer--%>
                <div class="row mb-3">
                    <div class="col-md-3">
                        <asp:Label Text="Id Trainer" ID="lblIdTrainer" runat="server" class="form-label" />
                        <asp:TextBox ID="txtIdTrainer" ReadOnly="true" class="form-control" runat="server" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <asp:CustomValidator ID="cvUserName" OnServerValidate="cvUserName_ServerValidate" ErrorMessage="Nombre de usuari@ ya utilizado..." ControlToValidate="txtUserName" ForeColor="Red" Display="Dynamic" runat="server" />
                    </div>
                    <!-- Contraseña -->
                    <div class="col-md-6">
                ...
                <!-- Botón -->
                <div class="text-end">
                    <asp:Button Text="Actualizar" ID="btnEditTrainer" OnClick="btnEditTrainer_Click" CssClass="btn btn-lg fw-bold btn-outline-warning" runat="server" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
